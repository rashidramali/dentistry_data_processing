...
df_master = pd.ExcelFile(excel_file)
#print(df_master)

#df_master.info()

#df_master_dict = df_master.to_dict()
#df_master_json = df_master.to_json()
#df_master_csv = df_master.to_csv(index=False)

#print(df_master_dict)
#print(df_master_json)
#print(df_master_csv)

#sheet_names = df_master.sheet_names
...
#print("Header Name: ",headers)
#print("Header Count:", len(headers))

#df_master = pd.read_excel(excel_file, sheet_name='Master List Baseline', usecols=['Email Address'])
#print(df_master)
#print(df_master.head(5))
#print(df_master.columns)
#print(df_master.dtypes)

#print(df_master['Timestamp'])
...
header_mapping = {
    ...
    "Nyatakan jenama ubat gigi anda\nState the brand of your toothpaste": "B3a",
...
# Duplicate a column and rename it
...
#knowledge_value_map_direct = {
#    "Betul / True": 1,
#    "Tidak tahu / Dont Know": 0,
#    "Salah / False": 0
#}
#knowledge_value_map_reverse = {
#    "Betul / True": 0,
#    "Tidak tahu / Dont Know": 0,
#    "Salah / False": 1
#}
#attitude_value_map_direct= {
#    "Sangat setuju / Strongly agree": 4,
#    "Setuju / Slightly agree": 3,
#    "Tidak setuju / Slightly disagree": 2,
#    "Sangat tidak setuju / Strongly disagree": 1
#}
#attitude_value_map_reverse = {
#    "Sangat setuju / Strongly agree": 1,
#    "Setuju / Slightly agree": 2,
#    "Tidak setuju / Slightly disagree": 3,
#    "Sangat tidak setuju / Strongly disagree": 4
#}
...
df_master = transform_column(df_master, 'B3a', {
...
df_master["Flouride-based"] = df_master["B3a"].copy()
...
#def behaviour_map_values(row):
#    b1_val = 1 if row['B1'] == '2 days and more' else 0
#    b2_val = 1 if row['B2'] == '2 days and more' else 0
#    b3_val = 1 if row['B3'] == 'Ya / Yes' else 0
#    b4_val = 1 if row['B4'] == 'Always' else 0
#    b5_val = 2 if row['B5'] == 'Sometimes / When in need' else (2 if row['B5'] == 'Using dental floss at least once' else 0)
#    b6_val = 1 if row['B6'] == 'More than 1 time a day' else 0
#    b7a_val = 1 if row['B7a'] == 'Yes / Sometimes' else 0
#    b7b_val = 1 if row['B7b'] == 'Yes / Sometimes' else 0
#    b7c_val = 1 if row['B7c'] == 'Yes / Sometimes' else 0
#    b7d_val = 1 if row['B7d'] == 'Yes / Sometimes' else 0
#    b7e_val = 1 if row['B7e'] == 'Yes / Sometimes' else 0
#    b7f_val = 1 if row['B7f'] == 'Yes / Sometimes' else 0
#    b7overall_val = 1 if row['B7-Overall'] == 'More than 4 times' else 0
...
#sorted_knowledge_score = np.sort(df_master["Knowledge Score"].unique())
#print("unique_Knowledge Score (sorted): ", sorted_knowledge_score)
#sorted_attitude_score = np.sort(df_master["Attitude Score"].unique())
#print("unique_Attitude Score (sorted): ", sorted_attitude_score)

# Print the updated DataFrame
#print(df_master[['B7a', 'B7b', 'B7c', 'B7d', 'B7e', 'B7f', 'B7-Overall']])

#print(df_master.columns)

#print(df_master['B7-Overall'].unique())
#print(df_master['B7-Overall Score'].unique())

#knowledge_response = ["K1", "K2", "K3"]
#df_master[knowledge_response] = df_master[knowledge_response].applymap(lambda x: 1 if x== "Betul / True" else (0 if x in ["Salah / False", "Tidak tahu / Dont Know"] else 999))
#df_master["Knowledge Score"] = df_master[knowledge_response].sum(axis=1)

#knowledge_response = ["K1", "K2", "K3", "K5", "K6", "K7", "K8", "K9", "K10", "K11", "K12", "K13", "K14", "K15", "K16"]
#df_master[knowledge_response] = df_master[knowledge_response].applymap(lambda x: knowledge_value_map_direct.get(x, 0))
#df_master["Knowledge Score - Direct"] = df_master[knowledge_response].sum(axis=1)
#knowledge_response = ["K4"]
#df_master[knowledge_response] = df_master[knowledge_response].applymap(lambda x: knowledge_value_map_reverse.get(x, 0))
#df_master["Knowledge Score - Reverse"] = df_master[knowledge_response].sum(axis=1)
#df_master["Knowledge Score - Overall"] = df_master["Knowledge Score - Direct"] + df_master["Knowledge Score - Reverse"]
#
#knowledge_response = ["A1a", "A1b", "A1c", "A1d", "A1e", "A1f", "A1g", "A2a", "A2b", "A3a", "A3b", "A3c", "A3d", "A4a", "A4b"]
#df_master[knowledge_response] = df_master[knowledge_response].applymap(lambda x: attitude_value_map_direct.get(x, 0))
#df_master["Attitude Score - Direct"] = df_master[knowledge_response].sum(axis=1)
#knowledge_response = ["A2c"]
#df_master[knowledge_response] = df_master[knowledge_response].applymap(lambda x: attitude_value_map_reverse.get(x, 0))
#df_master["Attitude Score - Reverse"] = df_master[knowledge_response].sum(axis=1)
#df_master["Attitude Score - Overall"] = df_master["Attitude Score - Direct"] + df_master["Attitude Score - Reverse"]

#print(df_master['School'].unique())
#print(df_master['Gender'].unique())
#print(df_master['B3a'].unique())
#print(df_master['Urban vs Rural'].unique())
#print(df_master['Controlled vs Intervention'].unique())
#print(df_master['Cigarette Count'].unique())
#print(df_master['Android User Check'].unique())
#print("unique_Knowledge Score",df_master['Knowledge Score'].unique())
#print("unique_K1:",df_master['K1'].unique())
#print("unique_K2:",df_master['K2'].unique())
#print("unique_K3:",df_master['K3'].unique())


#check_row = df_master[df_master["Attitude Score - Overall"] == 19]
#print(check_row)
#print(df_master["Attitude Score - Overall"].head(5))
...
df_master.rename(
    columns={
        'B3a' : 'Toothpaste Brand'
    }, inplace=True
)

#output_file = 'output.xlsx'
#df_master.to_excel(output_file, index=False)
#print(f"Excel has been Exported as {output_file}")
